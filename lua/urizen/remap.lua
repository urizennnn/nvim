...
keymap("n", "<leader>ct", "<cmd>Crates toggle<return>", opts)
keymap("n", "<leader>cr", "<cmd>Crates reload<return>", opts)
keymap("n", "<leader>cv", "<cmd>Crates show_versions_popup<return>", opts)
keymap("n", "<leader>cf", "<cmd>Crates show_features_popup<return>", opts)
keymap("n", "<leader>cd", "<cmd>Crates show_dependencies_popup<return>", opts)
keymap("n", "<leader>cu", "<cmd>Crates update_crate<return>", opts)
keymap("v", "<leader>cu", "<cmd>Crates update_crates<return>", opts)
keymap("n", "<leader>ca", "<cmd>Crates update_all_crates<return>", opts)
keymap("n", "<leader>cU", "<cmd>Crates upgrade_crate<return>", opts)
keymap("v", "<leader>cU", "<cmd>Crates upgrade_crates<return>", opts)
keymap("n", "<leader>cA", "<cmd>Crates upgrade_all_crates<return>", opts)
keymap("n", "<leader>cx", "<cmd>Crates expand_plain_crate_to_inline_table<return>", opts)
keymap("n", "<leader>cX", "<cmd>Crates extract_crate_into_table<return>", opts)
keymap("n", "<leader>cH", "<cmd>Crates open_homepage<return>", opts)
keymap("n", "<leader>cR", "<cmd>Crates open_repository<return>", opts)
keymap("n", "<leader>cD", "<cmd>Crates open_documentation<return>", opts)
keymap("n", "<leader>cC", "<cmd>Crates open_crates_io<return>", opts)
keymap("n", "<leader>cL", "<cmd>Crates open_lib_rs<return>", opts)
keymap("v", "p", '"_dP', opts)
keymap("v", "<leader>yl", function()
	vim.fn.setreg("+", string.lower(vim.fn.getreg('"')))
end, { desc = "Yank to clipboard and lowercase" })
